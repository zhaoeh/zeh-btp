package jp.co.futech.framework.common.exception.util;
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        ...
        return exception0(errorCode.getCode(), messagePattern).setI18n(errorCode.getI18n()).setParams(errorCode.getParams());
    }

    public static ServiceException exception(ErrorCode errorCode, Object... params) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getCode(), errorCode.getMsg());
        return exception0(errorCode.getCode(), messagePattern, params).setI18n(errorCode.getI18n()).setParams(errorCode.getParams());
    }

    /**
     * 期望expression为true，否则抛出自定义异常
     *
     * @param expression boolean 条件表达式
     * @param errorCode  ErrorCode
     */
    public static void isTrue(boolean expression, ErrorCode errorCode, Object... params) {
        if (!expression) {
            throw exception(errorCode, params);
        }
    }

    /**
     * 期望map不为empty，否则抛出自定义异常
     *
     * @param map       map
     * @param errorCode ErrorCode
     */
    public static void notEmpty(@Nullable Map<?, ?> map, ErrorCode errorCode, Object... params) {
    ...
    /**
     * 期望object不为null，否则抛出自定义异常
     *
     * @param object    object
     * @param errorCode ErrorCode
     */
    public static void notNull(@Nullable Object object, ErrorCode errorCode, Object... params) {
        if (object == null) {
            throw exception(errorCode, params);
        }
    }
