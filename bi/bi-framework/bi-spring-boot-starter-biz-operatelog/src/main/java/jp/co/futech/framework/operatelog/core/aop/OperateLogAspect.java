package jp.co.futech.framework.operatelog.core.aop;
...
import jp.co.futech.framework.operatelog.core.service.OperateLog;
...
import static jp.co.futech.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static jp.co.futech.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        jp.co.futech.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                jp.co.futech.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         jp.co.futech.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           jp.co.futech.framework.operatelog.core.annotations.OperateLog operateLog,
