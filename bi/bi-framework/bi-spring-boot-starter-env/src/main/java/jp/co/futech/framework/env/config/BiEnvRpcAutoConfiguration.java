...
import jp.co.futech.framework.env.core.fegin.EnvLoadBalancerClientFactory;
import jp.co.futech.framework.env.core.fegin.EnvRequestInterceptor;
...
public class BiEnvRpcAutoConfiguration {
