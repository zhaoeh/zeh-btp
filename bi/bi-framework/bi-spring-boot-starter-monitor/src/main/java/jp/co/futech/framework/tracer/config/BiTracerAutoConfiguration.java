package jp.co.futech.framework.tracer.config;

import jp.co.futech.framework.common.enums.WebFilterOrderEnum;
import jp.co.futech.framework.tracer.core.aop.BizTraceAspect;
import jp.co.futech.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "bi.tracer", value = "enable", matchIfMissing = true)
public class BiTracerAutoConfiguration {
