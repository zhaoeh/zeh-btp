package jp.co.futech.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${bi.websocket.sender-rocketmq.topic}",
        consumerGroup = "${bi.websocket.sender-rocketmq.consumer-group}",
