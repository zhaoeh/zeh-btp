...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "jp.co.futech";
    private static final String ARTIFACT_ID = "bi";
    private static final String PACKAGE_NAME = "jp.co.futech";
    private static final String TITLE = "futech-bi系统";
    ...
    public static void main(String[] args) {
        ...
        String projectBaseDir = "D:\\project\\bi-cloud-master-jdk21";
        log.info("[main][原项目路劲改地址 ({})]", projectBaseDir);

        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "jp.co.futech";
        String artifactIdNew = "bi";
        String packageNameNew = "jp.co.futech";
        String titleNew = "futech-bi系统";
        String projectBaseDirNew = "D:\\project\\futech-bi"; // 一键改名后，“新”项目所在的目录
