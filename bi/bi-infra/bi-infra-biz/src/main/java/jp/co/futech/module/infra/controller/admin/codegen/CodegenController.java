package jp.co.futech.module.infra.controller.admin.codegen;
...
import jp.co.futech.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import jp.co.futech.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import jp.co.futech.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import jp.co.futech.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import jp.co.futech.module.infra.convert.codegen.CodegenConvert;
...
import jp.co.futech.module.infra.service.codegen.CodegenService;
...
import static jp.co.futech.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "bi"),
