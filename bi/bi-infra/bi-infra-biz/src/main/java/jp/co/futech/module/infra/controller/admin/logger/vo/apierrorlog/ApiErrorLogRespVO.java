package jp.co.futech.module.infra.controller.admin.logger.vo.apierrorlog;
...
import jp.co.futech.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(jp.co.futech.module.system.enums.DictTypeConstants.USER_TYPE)
