package jp.co.futech.module.infra.service.codegen.inner;
...
import jp.co.futech.framework.common.util.date.LocalDateTimeUtils;
...
import jp.co.futech.framework.excel.core.annotations.DictFormat;
import jp.co.futech.framework.excel.core.convert.DictConvert;
import jp.co.futech.framework.excel.core.util.ExcelUtils;
import jp.co.futech.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "bi-${table.moduleName}/" + // 顶级模块
                "bi-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "bi-${table.moduleName}/" + // 顶级模块
                "bi-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "bi-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "bi-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
