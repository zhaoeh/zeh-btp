...
import jp.co.futech.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import jp.co.futech.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static jp.co.futech.framework.common.util.date.LocalDateTimeUtils.*;
...
import static jp.co.futech.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static jp.co.futech.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("bi-test");
