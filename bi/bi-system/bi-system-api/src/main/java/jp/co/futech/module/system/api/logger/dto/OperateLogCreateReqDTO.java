package jp.co.futech.module.system.api.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "jp.co.futech.UserController.save(...)")
