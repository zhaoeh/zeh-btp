package jp.co.futech.module.system.api.oauth2;

import jp.co.futech.framework.common.pojo.CommonResult;
import jp.co.futech.module.system.api.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
...
public interface OAuth2TokenApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "biyuanma")
    })
