package jp.co.futech.module.system.controller.admin.auth;
...
import jp.co.futech.framework.security.config.SecurityProperties;
import jp.co.futech.framework.security.core.util.SecurityFrameworkUtils;
import jp.co.futech.module.system.config.I18nMessagesConfig;
...
import jp.co.futech.module.system.service.auth.AdminAuthService;
...
public class AuthController {
    ...
    @EnableI18nWeavingForResponse(mapperConfigure = I18nMessagesConfig.MenuI18nCodeMapper.class)
...
//    @PermitAll
//    @Operation(summary = "返回谷歌绑定的二维码")
//    public CommonResult<String> getMfaQrcode(@RequestParam("userName") String userName) {
//        return success(authService.getMfaQrcode(userName));
//    }
//
//    @PostMapping("/mfa-check-code")
//    @PermitAll
//    @Operation(summary = "校验二次验证码")
//    public CommonResult<AuthLoginRespVO> mfaCheckCode(@RequestBody @Valid AuthLoginMfaReqVO mfaReqVO) {
//        return success(authService.mfaCheckCode(mfaReqVO));
//    }

//    @PutMapping("/mfa-binding")
//    @PermitAll
//    @Operation(summary = "客户确认绑定成功")
//    public CommonResult<Boolean> updateMfaBindingStatus(@RequestParam("id") Long id) {
//        userService.updateMfaBindingStatus(id);
//        return success(true);
//    }
}
