...
public class AuthPermissionInfoRespVO {
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单展示名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋道")
        private String name;

        @Schema(description = "菜单国际化名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋道")
        @I18nField
