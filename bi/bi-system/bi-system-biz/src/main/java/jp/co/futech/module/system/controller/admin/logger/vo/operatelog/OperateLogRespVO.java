package jp.co.futech.module.system.controller.admin.logger.vo.operatelog;
...
import jp.co.futech.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "jp.co.futech.adminserver.UserController.save(...)")
