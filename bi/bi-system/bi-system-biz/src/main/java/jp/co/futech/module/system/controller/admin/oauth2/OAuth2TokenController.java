...
import jp.co.futech.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import jp.co.futech.module.system.api.oauth2.dto.OAuth2AccessTokenRespDTO;
import jp.co.futech.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
import jp.co.futech.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenRespVO;
...
public class OAuth2TokenController {
    ...
    @Parameters({
            @Parameter(name = "userId", required = true, description = "用户ID", example = "142"),
            @Parameter(name = "userType", required = true, description = "用户类型", example = "1"),
            @Parameter(name = "clientId", description = "clientId", example = "default"),
    })
