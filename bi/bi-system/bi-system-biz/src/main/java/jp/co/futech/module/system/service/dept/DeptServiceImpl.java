...
import jp.co.futech.module.system.controller.admin.dept.vo.dept.DeptListReqVO;
import jp.co.futech.module.system.controller.admin.dept.vo.dept.DeptSaveReqVO;
import jp.co.futech.module.system.dal.dataobject.dept.DeptDO;
import jp.co.futech.module.system.dal.mysql.dept.DeptMapper;
    ...
    public void validateDeptList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!CommonStatusEnum.ENABLE.getStatus().equals(dept.getStatus())) {
                throw exception(DEPT_NOT_ENABLE.setParams(Map.of("name", dept.getName())), dept.getName());
            }
        });
    }
