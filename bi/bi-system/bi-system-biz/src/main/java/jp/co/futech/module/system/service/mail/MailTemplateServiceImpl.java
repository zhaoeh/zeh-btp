package jp.co.futech.module.system.service.mail;
...
import jp.co.futech.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import jp.co.futech.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import jp.co.futech.module.system.dal.dataobject.mail.MailTemplateDO;
import jp.co.futech.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static jp.co.futech.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_CODE_EXISTS;
import static jp.co.futech.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImpl implements MailTemplateService {
    ...
    void validateCodeUnique(Long id, String code) {
        ...
        if (id == null // 新增时，说明重复
            ...
            throw exception(MAIL_TEMPLATE_CODE_EXISTS.setParams(Map.of("code", code)), code);
        }
    }
