package jp.co.futech.module.system.service.notify;
...
import jp.co.futech.module.system.controller.admin.notify.vo.template.NotifyTemplatePageReqVO;
import jp.co.futech.module.system.controller.admin.notify.vo.template.NotifyTemplateSaveReqVO;
import jp.co.futech.module.system.dal.dataobject.notify.NotifyTemplateDO;
import jp.co.futech.module.system.dal.mysql.notify.NotifyTemplateMapper;
...
import static jp.co.futech.module.system.enums.ErrorCodeConstants.NOTIFY_TEMPLATE_CODE_DUPLICATE;
import static jp.co.futech.module.system.enums.ErrorCodeConstants.NOTIFY_TEMPLATE_NOT_EXISTS;
...
public class NotifyTemplateServiceImpl implements NotifyTemplateService {
    ...
    void validateNotifyTemplateCodeDuplicate(Long id, String code) {
        ...
        if (id == null) {
            throw exception(NOTIFY_TEMPLATE_CODE_DUPLICATE.setParams(Map.of("code",code)), code);
        }
