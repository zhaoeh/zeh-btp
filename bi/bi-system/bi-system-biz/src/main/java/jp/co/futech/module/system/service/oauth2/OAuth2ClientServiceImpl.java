...
import jp.co.futech.module.system.controller.admin.oauth2.vo.client.OAuth2ClientSaveReqVO;
import jp.co.futech.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import jp.co.futech.module.system.dal.mysql.oauth2.OAuth2ClientMapper;
...
public class OAuth2ClientServiceImpl implements OAuth2ClientService {
    ...
    public OAuth2ClientDO validOAuthClientFromCache(String clientId, String clientSecret, String authorizedGrantType,
        ...
        if (StrUtil.isNotEmpty(clientSecret) && ObjectUtil.notEqual(client.getSecret(), clientSecret)) {
            throw exception(OAUTH2_CLIENT_CLIENT_SECRET_ERROR.setParams(Map.of("clientSecret", clientSecret)), clientSecret);
        }
        // 校验授权方式
        ...
        if (StrUtil.isNotEmpty(redirectUri) && !StrUtils.startWithAny(redirectUri, client.getRedirectUris())) {
            throw exception(OAUTH2_CLIENT_REDIRECT_URI_NOT_MATCH.setParams(Map.of("redirectUri",redirectUri)), redirectUri);
        }
        return client;
    }
