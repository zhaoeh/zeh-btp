...
import jp.co.futech.module.system.dal.redis.RedisKeyConstants;
...
public class SmsTemplateServiceImpl implements SmsTemplateService {
    ...
    public void validateSmsTemplateCodeDuplicate(Long id, String code) {
        ...
        if (id == null) {
            throw exception(SMS_TEMPLATE_CODE_DUPLICATE.setParams(Map.of("code", code)), code);
        }
    ...
    void validateApiTemplate(Long channelId, String apiTemplateId) {
        ...
        try {
            ...
            throw exception(SMS_TEMPLATE_API_ERROR.setParams(Map.of("msg", msg)), msg);
        }
        // 校验短信模版
        if (template == null) {
        ...
        if (Objects.equals(template.getAuditStatus(), SmsTemplateAuditStatusEnum.FAIL.getStatus())) {
            throw exception(SMS_TEMPLATE_API_AUDIT_FAIL.setParams(Map.of("reason", template.getAuditReason())), template.getAuditReason());
        }
