...
import jp.co.futech.framework.common.util.cache.CacheUtils;
import jp.co.futech.framework.common.util.http.HttpUtils;
import jp.co.futech.framework.common.util.object.BeanUtils;
import jp.co.futech.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import jp.co.futech.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import jp.co.futech.module.system.dal.dataobject.social.SocialClientDO;
import jp.co.futech.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImpl implements SocialClientService {
    ...
    public AuthUser getAuthUser(Integer socialType, Integer userType, String code, String state) {
        ...
        if (!authResponse.ok()) {
            throw exception(SOCIAL_USER_AUTH_FAILURE.setParams(Map.of("msg", authResponse.getMsg())), authResponse.getMsg());
        }
