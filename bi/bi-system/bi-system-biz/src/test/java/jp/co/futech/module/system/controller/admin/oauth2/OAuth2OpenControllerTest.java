package jp.co.futech.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import jp.co.futech.framework.common.core.KeyValue;
...
import jp.co.futech.framework.common.util.collection.SetUtils;
import jp.co.futech.framework.common.util.object.ObjectUtils;
import jp.co.futech.framework.test.core.ut.BaseMockitoUnitTest;
import jp.co.futech.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import jp.co.futech.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import jp.co.futech.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import jp.co.futech.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import jp.co.futech.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import jp.co.futech.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import jp.co.futech.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import jp.co.futech.module.system.service.oauth2.OAuth2ApproveService;
import jp.co.futech.module.system.service.oauth2.OAuth2ClientService;
import jp.co.futech.module.system.service.oauth2.OAuth2GrantService;
...
import static jp.co.futech.framework.common.util.collection.SetUtils.asSet;
...
import static jp.co.futech.framework.test.core.util.RandomUtils.randomPojo;
import static jp.co.futech.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testPostAccessToken_implicit() {
        ...
        assertServiceException(() -> oauth2OpenController.postAccessToken(null,
                        ...
                        null, null, null, null),
                new ErrorCode(400, "Token 接口不支持 implicit 授权模式", null));
    }
    ...
    public void testApproveOrDeny_grantTypeError() {
        ...
        assertServiceException(() -> oauth2OpenController.approveOrDeny(randomString(), null,
                        null, null, null, null),
                new ErrorCode(400, "response_type 参数值只允许 code 和 token", null));
    }
