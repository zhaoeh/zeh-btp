...
import jp.co.futech.framework.common.util.collection.ArrayUtils;
...
import jp.co.futech.module.system.dal.dataobject.dept.PostDO;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("biyuanma");
        ...
        assertEquals("biyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("biyuanma"))).thenReturn("java");
